...
public class DepartmentPage {
    ...
    //tbody//tr[contains(@onclick,'selectrow(departments,this);')][1]//td
    //tbody//tr[contains@onclick,'selectrow(departments,this);')][1]//td
    List<WebElement> allInformation;
    @FindBy(xpath = "//li[@id='main_parent_5']")
    WebElement background;

    public void addDepartment(String departmentName, String businessUnit, String departmentCode,
                              String departmentHead,String city){
        addButton.click();
    ...
    public void validateInformation(){
        List<String> expectedInformation= Arrays.asList("Information Technology", "IT","01/05/2001",
